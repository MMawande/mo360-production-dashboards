...
tb_einrichtpunkte_baureihe_dbf_0670 = tb_einrichtpunkte_baureihe_dbf_0670.withColumn(
    "punkt",
...
join_condition_sma = (
    (
        ...
        == tb_einrichtpunkte_baureihe_dbf_0670["messwerttyp"]
    ) &
    (
        processed_iqvis_filtered_sma["fzg_typ"]
        == tb_einrichtpunkte_baureihe_dbf_0670["fzg_typ"]
    )
    & (
        processed_iqvis_filtered_sma["origin"]
        == tb_einrichtpunkte_baureihe_dbf_0670["origin"]
    )
)
...
join_result_sma = (
    ...
    .join(tb_einrichtpunkte_baureihe_dbf_0670, join_condition_sma, "left")
    .distinct()
)
...
join_result_bfk_sme = (
    ...
    .join(tb_einrichtpunkte_baureihe_dbf_0670, join_condition_bfk_sme, "left")
    .distinct()
)
...
tb_final.write.saveAsTable(
    f"`{catalog}`.`{processed_schema}`.tra_dbf_0670_karnrresult", mode="overwrite"
)
